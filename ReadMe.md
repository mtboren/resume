...
* PowerShell (Expert), Python, Shell, C\#, HCL2, JavaScript, etc.
* github.com/mtboren
...
**Eli Lilly (via Virtusa) | Indianapolis, IN** | *Oct 2018 – Mar 2022*

**Automation Engineer (Hosting & Cloud Services)**
...
**Automation Engineer, Infrastructure Specialist (Global Virtualization)**
Force-multiplied global infrastructure capabilities by spreading computational thought processes across the enterprise.

* **Product Development:** Designed and maintained "vmDeploy," an enterprise self-service provisioning product (PowerShell & ASP.NET/C\#) that reduced deployment times from weeks to minutes.
* **Orchestration:** Orchestrated the automated deployment of tens of thousands of Windows and Linux VMs and enterprise storage clusters.
* **Virtualization & Security:** Scaled management for global virtualization estates including VMware vSphere, VMware View VDI, network virtualization.